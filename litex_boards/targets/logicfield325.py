...
from litex_boards.platforms import logicfield325
...
class BaseSoC(SoCCore):
    def __init__(self, sys_clk_freq=int(75e6), with_ethernet=False, **kwargs):
        platform = logicfield325.Platform()

        # SoCCore ----------------------------------------------------------------------------------
        SoCCore.__init__(self, platform, sys_clk_freq,
            ident          = "LiteX SoC on LogicField325",
            ident_version  = True,
            **kwargs)
...
def main():
    parser = argparse.ArgumentParser(description="LiteX SoC on LogicField325")
